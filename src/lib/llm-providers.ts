...
export const LLM_PROVIDERS: LlmProvider[] = [
  ...
  },
  {
    ...
    needsBaseUrl: false,
    models: [
      { value: 'gpt-5.4',       label: 'GPT-5.4',       description: 'Flagship' },
      { value: 'gpt-5.4-mini',  label: 'GPT-5.4 mini',  description: 'Fast & affordable' },
      { value: 'gpt-5.4-nano',  label: 'GPT-5.4 nano',  description: 'Cheapest' },
  ...
  },
  {
    ...
    needsBaseUrl: false,
    models: [
      { value: 'gemini-3.1-pro-preview', label: 'Gemini 3.1 Pro (preview)', description: 'Flagship' },
      { value: 'gemini-3.1-flash-lite-preview', label: 'Gemini 3.1 Flash Lite (preview)', description: 'Cheapest' },
      { value: 'gemini-3.1-flash-live-preview', label: 'Gemini 3.1 Flash Live (preview)', description: 'Low-latency / streaming' },
      { value: 'gemini-3.1-flash-image-preview', label: 'Gemini 3.1 Flash Image (preview)', description: 'Image generation' },
      { value: 'gemini-3-flash-preview', label: 'Gemini 3 Flash (preview)', description: 'Fast & capable' },
      { value: 'gemini-3-pro-image-preview', label: 'Gemini 3 Pro Image (preview)', description: 'High-quality image gen' },
      { value: 'gemini-2.0-flash', label: 'Gemini 2.0 Flash', description: 'Fast & capable' },
      { value: 'gemini-2.0-flash-lite', label: 'Gemini 2.0 Flash Lite', description: 'Cheap' },
  ...
  },
  {
    ...
    models: [
      ...
      { value: 'deepseek/deepseek-v4-pro', label: 'DeepSeek V4 Pro (via OR)', description: 'DeepSeek flagship' },
      { value: 'deepseek/deepseek-v4-flash', label: 'DeepSeek V4 Flash (via OR)', description: 'Fast & cheap' },
      { value: 'openai/gpt-5.4-image-2', label: 'GPT-5.4 Image 2 (via OR)', description: 'Image generation' },
      { value: 'moonshotai/kimi-k2.6', label: 'Kimi K2.6 (via OR)', description: 'Moonshot — long context' },
      { value: 'perplexity/sonar-deep-research', label: 'Sonar Deep Research (via OR)', description: 'Web-grounded research' },
